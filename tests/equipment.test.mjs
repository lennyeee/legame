...
test('农民是已拥有未装备的Lv.1被动道具，未知/未拥有不可装备，装备卸下幂等',()=>{
 const inventory=createInventory();assert.deepEqual(inventory,itemDefinitions.map(({id})=>({id,level:1,owned:true,equipped:false})));assert.equal(inventory.length,itemDefinitions.length);
