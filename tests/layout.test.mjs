...
test('当前地图8×5方格紧贴，28部署（6已解锁22锁定），所有非道路格都有地皮状态',()=>{
 ...
 assert.equal(testMap.cells.filter(c=>c.unlocked).length,6);assert.equal(testMap.cells.filter(c=>!c.unlocked).length,22);
